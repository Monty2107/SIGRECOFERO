...
use SIGRECOFERO\Http\Requests;
use SIGRECOFERO\Http\Controllers\Controller;
use Log;
use Response;
use Storage;
use Artisan;
  ...
  public function index()
      {
        ...
        //   dump($backups);
          return view("admin.seguridad.backups")->with(compact('backups'));
      }
      public function create()
      {
          try {
              ...
              bitacora::bitacoras('Crear','Creacion de Restauracion de Proyecto y Base ');
      ...
      public function create1()
      {
          try {
              ...
              Log::info("Backpack\BackupManager -- new backup started from admin interface \r\n" . $output);
              // return the results as a response to the ajax call
              bitacora::bitacoras('Crear','Creacion de Restauracion de Base ');
              return redirect()->back();
          } catch (Exception $e) {
            flash($e->getMessage())->error();
      ...
      {
        bitacora::bitacoras('Descarga','Descargo Restauracion de Base ');
