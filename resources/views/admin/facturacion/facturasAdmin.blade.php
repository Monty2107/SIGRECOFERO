...
<?php 
if($f->concepto == 'Administrativo' && $f->id_Condominio % 2 == '1'){
?>
<body> 
        <div class="col-md-12">
...
<?php 
        ...
        $f2 = \SIGRECOFERO\facturacion::where('concepto','=','Administrativo')->where('emision','=','No Emitido')->where('id_Condominio','=',$f->id_Condominio)->get()->last();
