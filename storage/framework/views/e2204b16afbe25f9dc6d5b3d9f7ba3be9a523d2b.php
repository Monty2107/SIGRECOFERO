  ...
  <div class="col-md-12">
    <div class="box-body">
      <div class="box-header with-border">
        ...
        <div style="position: absolute;left: 200px; top: 160px; index: 1;"><h3><?php echo e($condomine->codigo); ?> </h3></div>
        <div style="position: absolute;left: 20px; top: 180px; z-index: 1;"><h3>Nombre Del Condomine:</h3></div>
        <div style="position: absolute;left: 200px; top: 180px; index: 1;"><h3><?php echo e($condomine->nombre); ?> </h3></div>
        <div style="position: absolute;left: 20px; top: 200px; index: 1;"><h3>Local N°:</h3></div>
        <div style="position: absolute;left: 200px; top: 200px; index: 1;"><h3><?php echo e($condomine->NLocal); ?> </h3></div>
        <div style="position: absolute;left: 20px; top: 220px; z-index: 1;"><h3>Telefono Fijo: </h3></div>
        <div style="position: absolute;left: 200px; top: 220px; index: 1;"><h3><?php echo e($condomine->empresa->telefonoFijo); ?> </h3></div>
        <div style="position: absolute;left: 20px; top: 240px; z-index: 1;"><h3>Contacto: </h3></div>
        <div style="position: absolute;left: 200px; top: 240px; index: 1;"><h3> <?php echo e($condomine->empresa->nombre); ?> </h3></div>
        ...
        <table class="table-wrapper" >
          ...
          <tbody>
            <?php $n=1; ?>              
             ...
             <?php $__currentLoopData = $factura; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
              <tr>
                  <?php $fecha1 = \SIGRECOFERO\fecha::find($f->id_Fecha); ?>
              <td style = "width:5%"><?php echo e($n); ?></td> 
              <td style = "width:7%"><?php echo e($fecha1->dia.' - '.$fecha1->mes.' - '.$fecha1->ano); ?></td>
              <td style = "width:20%"><?php echo e($condomine->empresa->nombre); ?></td>
              <td style = "width:10%"><?php echo e($f->concepto); ?></td>
              <td style = "width:7%"><?php echo e($f->mes); ?></td>
              <td style = "width:5%"><?php echo e($f->cantidad); ?></td>
