...
<?php if(count($errors) > 0): ?>
      ...
      <?php endif; ?>
<?php echo Form::model($usuario,['route' => ['usuario.update',$usuario->id], 'method' => 'PUT','id'=>'form']); ?>
        ...
        <div class="box-header with-border">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <?php echo Form::text('nombre',$usuario->name,['name'=>'nombre','id'=>'nombre','class'=>'form-control','placeholder'=>'Ingrese Su Nombre.....']); ?>

            </div>
            
            <div class="form-group">
              <label >Correo: </label>
              <?php echo Form::email('correo',$usuario->email,['id'=>'correo','name'=>'correo','class'=>'form-control','placeholder'=>'ejemplo: empresa@mail.com','pattern'=>'[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,3}']); ?>
            ...
            <div class="form-group">
              <label >Cargo: </label>
                <?php echo Form::text('cargo',$usuario->cargo,['disabled','class'=>'form-control']); ?>
